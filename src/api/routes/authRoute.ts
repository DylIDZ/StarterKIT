...
authRegistry.registerPath({
    ...
    responses: createApiResponse(z.object({ user: UserSchema }), "User registered successfully"),
});
...
authRegistry.registerPath({
    ...
    responses: createApiResponse(
        ...
        "Login successful — refresh token set as HttpOnly cookie",
    ),
});
...
authRegistry.registerPath({
    ...
    responses: createApiResponse(z.object({ accessToken: z.string() }), "Token refreshed successfully"),
});
...
authRegistry.registerPath({
    ...
    tags: ["Auth"],
    security: [{ bearerAuth: [] }],
    description: "Logout — clears refresh token HttpOnly cookie and invalidates session",
